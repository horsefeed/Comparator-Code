...
Author: Xorsheed Zanjani <xorsheed.zanjani@kcl.ac.uk>
Co-Author: Aamir Faaiz <mohamed.faaiz@kcl.ac.uk>
...
#pA
beta = 350 #pA/K
T = 19.9*np.ones(5000) #Constant Temperature of 23C
...
W1=[[0,0],
   [7500,0]] #this shouldnt effect N1 response, only N2 response 
...
#pA
beta = 350 #pA/K
T = 19*np.ones(5000) #Constant Temperature of 23C
...
plt.legend()
plt.title("Spike Frequency Response of Comparator")
